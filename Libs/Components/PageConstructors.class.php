...
class PageConstructors
{
    ...
    public static function ToTitleAdd(array &$array,string $string,string $section=''):bool {
    ...
    public static function PagesNavAdd(array &$array,string $section,int $current_page,int $pages_count):bool {
        $status = false;
        $base_link = self::GetBaseLink().'page'.'=';
    ...
    public static function GetBaseLink():string {
        ...
        $main_link = !empty($_GET[$get_key])?'?'.$get_key.'='.$_GET[$get_key].'&':'?';
