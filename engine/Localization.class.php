...
class Localization
{
    ...
    const ERROR_MODULE_OUTPUT_DATA_1 = self::ERROR . ' ' . 'Данные, которые вернул модуль, не соответствуют шаблону!';
    const ERROR_MODULE_OUTPUT_DATA_2 = self::ERROR . ' ' . 'Внутренние данные не являются массивом!';
    ...
    const ERROR_LOAD_TEMPLATES_DIR = self::ERROR . ' ' . 'Не удалось подключить директорию с шаблонами!';
    const ERROR_LOAD_MODULES_DIR = self::ERROR . ' ' . 'Не удалось подключить директорию с модулями!';
    ...
    const ERROR_ARTICLES_MODULE_LOAD_DIR = 'Не удалось подключить директорию со статьями!';
    ...
    const ERROR_GALLERY_MODULE_LOAD_DIR = 'Не удалось подключить директорию с галереей!';
    ...
    const ERROR_STATIC_MODULE_LOAD_DIR = 'Не удалось подключить директорию со страницами!';
}